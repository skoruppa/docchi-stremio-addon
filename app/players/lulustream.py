...
async def fetch_resolution_from_m3u8(m3u8_url, headers):
...
async def get_video_from_lulustream_player(filelink):
    ...
    quality = await fetch_resolution_from_m3u8(stream_url, headers)

    stream_headers = {'request': headers}

    return stream_url, f'{quality}p', stream_headers
