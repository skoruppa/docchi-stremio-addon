...
from app.players.abyss import get_video_from_abyss_player
...
supported_streams = ['cda', 'lycoris.cafe', 'ok', 'sibnet', 'dailymotion', 'vk', 'gdrive', 'google drive', 'uqload',
                     ...
                     'mp4upload', 'filemoon', 'earnvid', 'streamup', 'abyss']
...
async def process_player(player):
    ...
    elif player_hosting == 'abyss':
        url, quality, headers = await get_video_from_abyss_player(player['player'])
