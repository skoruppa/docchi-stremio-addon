...
BATCH_TRANSLATE_PROMPT = (
    ...
    "Prefer natural-sounding Polish titles over literal translations.\n"
    "Freely adapt titles to sound natural in Polish — use Polish idioms, phrases, and expressions "
    "instead of literal translations. Example: 'Like a Villainess' could become "
    "'Jak na czarny charakter przystało' rather than word-for-word 'Jak złoczyńczyni'.\n"
